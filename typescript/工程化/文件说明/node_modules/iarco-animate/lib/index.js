...
this.myPlugin.mixin = function () {
    ...
    for (let i = 0; i < arguments.length; i++) {
        if (arguments[i].constructor !== Object) {
            throw new Error('argument is must object,Do you sure arguments is Object?')
        };
 ...
 * 深拷贝
 */
this.myPlugin.deepCopy = function (obj) {
    var res = null;
